$(document).ready(function () {
  ...
  $("#search-button").click(function(event){
    ...
    $.ajax({
      type: 'GET',
      url: 'http://localhost:64842/dvds/' + $('#search-category').val() + '/' + $('#search-term').val(),
...
function gotoTitle(dvdId){
  ...
  $.ajax({
    type: 'GET',
    url: 'http://localhost:64842/dvd/' + dvdId,
    success: function(data, status) {
      ...
      var director = data.directorName;
      var rating = data.ratingValue;
...
function showEditForm(dvdId){
  ...
  $.ajax({
    ...
    success: function(data, status){
      ...
      $('#edit-rating').val(data.ratingValue);
